      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <FadeInLeft className="relative">
            <RevealImage className="relative overflow-hidden rounded-2xl aspect-[4/3]">
              <img
            ...
            <div className="absolute -bottom-6 -right-6 w-48 h-48 bg-primary rounded-2xl overflow-hidden hidden lg:block shadow-xl">
              <img
            ...
            <div className="absolute -top-4 -left-4 w-32 h-32 bg-accent rounded-xl flex flex-col items-center justify-center text-white hidden lg:flex shadow-lg">
              <span className="font-heading font-bold text-3xl">10+</span>
              <span className="text-xs text-white/80 text-center leading-tight mt-1">{t.about.experience}</span>
            </div>
          </FadeInLeft>
