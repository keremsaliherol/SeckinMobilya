          ...
          {projects.map((project, idx) => (
            <StaggerItem key={project.id} className="bg-background">
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 translate-y-full group-hover:translate-y-0 transition-transform duration-500 ease-[cubic-bezier(0.76,0,0.24,1)] bg-primary-dark/95 backdrop-blur-sm p-6">
