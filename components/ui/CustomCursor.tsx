...
export default function CustomCursor() {
  ...
  useEffect(() => {
    // Dokunmatik cihazlarda fare imleci yok; dinleyicileri hiç bağlama.
  ...
  return (
    <div
      ref={ringRef}
      aria-hidden="true"
      className="custom-cursor fixed pointer-events-none z-[9999] -translate-x-1/2 -translate-y-1/2 rounded-full"
      style={{
