...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  /**
   * Adresler sonunda eğik çizgiyle biter. Site `trailingSlash: true` ile
   * üretiliyor ve canonical etiketleri de bu biçimi kullanıyor; sitemap
   * farklı yazılırsa arama motorları iki ayrı adres görüp karışır.
   */
  const staticRoutes = [
    { path: "/", priority: 1 },
