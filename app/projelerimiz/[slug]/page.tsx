...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${project.title} | Seçkin Mobilya & İnşaat`,
      ...
      <section className="relative h-[60vh] min-h-[400px] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full pb-16">
            ...
            <span className="text-xs font-medium tracking-widest uppercase text-white/60 mb-3 block">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Link
                href="/iletisim"
                className="bg-primary text-white font-medium py-3.5 px-6 rounded text-center hover:bg-primary-dark transition-colors flex items-center justify-center gap-2"
              >
